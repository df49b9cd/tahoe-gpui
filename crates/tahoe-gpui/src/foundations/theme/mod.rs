...
pub use super::typography::{
    ...
    TextStyledExt, TruncationMode, bold_step, macos_tracking, platform_text_size,
};
...
pub struct TahoeTheme {
    ...
    /// of their trigger. 4 pt is a small visual gap that keeps the
    /// dropdown anchored to its trigger while still reading as a
    /// separate surface; see [`TahoeTheme::dropdown_top`] for the full
    /// `target_size + offset` derivation.
...
impl TahoeTheme {
    ...
    fn build_component_sizes() -> ComponentSizes {
        ComponentSizes {
            ...
            menu_inset: px(6.0),
            avatar_size: px(32.0), // AvatarSize::Standard — canonical HIG default
            icon_size: px(16.0),
